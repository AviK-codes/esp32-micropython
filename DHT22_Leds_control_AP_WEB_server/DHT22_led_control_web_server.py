...
tim1.init(period=2000, mode=Timer.PERIODIC, callback=read_us_callback)
...
#        <center><p>temperature is <strong>""" + str(temperature) + """ CM</strong>.</p></center> 
#        <center><p>temperature is <strong>""" + str(temperature/100) + """ M</strong>.</p></center>
#        <center>    
#           <form>    
...
#    return html_page
   html_page = """
    ...
    <body>
        ...
        <center>
            <p>temperature is <strong>""" + str(temperature) + """c</strong>.</p>
            <p>humidity is <strong>""" + str(humidity) + """% </strong>.</p>
        </center>
        <center>
            <form>
